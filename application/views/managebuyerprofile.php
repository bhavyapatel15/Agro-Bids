    ...
    <section class="py-4 osahan-main-body">
            ...
            <div class="row">
               <div class="col-lg-4">
                  <div class="osahan-account bg-white rounded shadow-sm overflow-hidden">
                     ...
                     <div class="account-sections">
                        <ul class="list-group">
                           <a href="<?=site_url('managebuyerprofile')?>" class="text-decoration-none text-dark">
               ...
               <div class="col-lg-8 p-4 bg-white rounded shadow-sm">
                  ...
                  <div id="edit_profile">
                     <div class="p-0">
                        <form action="<?=site_url('manageprofile/updatebuyer/'.$profileInfo[0]->userid.'/'.$profileInfo[0]->buyerid)?>" method="post" enctype="multipart/form-data">
                           <?php
                                 foreach($profileInfo as $p)
                                 {
                           ?>
                                 <div class="form-group">
                                    <label for="exampleInputName1">Buyer Name</label>
                                    <input type="text" class="form-control" name="txtname" value="<?=$p->buyername?>">
                                 </div>
                                 <div class="form-group">
                                    <label for="exampleInputNumber1">Contact Number</label>
                                    <input type="number" class="form-control" name="txtcontact"  value="<?=$p->contact?>">
                                 </div>
                                 <div class="form-group">
                                    <label for="exampleInputEmail1">Email</label>
                                    <input type="email" class="form-control" name="txtemail" value="<?=$p->email?>">
                                 </div>
                                  <div class="form-group">
                                    <label for="exampleInputNumber1">Bio</label>
                                    <textarea class="form-control" rows="3" name="txtbio" cols="10" ><?=$p->bio?></textarea>
                                 </div>
                                  <div class="form-group">
