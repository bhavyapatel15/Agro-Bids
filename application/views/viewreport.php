                        ...
                        <table class="table">
                            ...
                            <tbody>
                              ...
                              <tr class="text-center ">
                                ...
                                <td class="image-prod"><div class="img" style="background-image:url(<?=base_url('resources/user/assets/img/'.$r->profilephoto)?>);  border-radius:50%"></div>
                                </td>
                                ...
                                <td class="product-name">
                                    <h3> <?php echo date("d-m-Y", strtotime($r->reportdt)) ?></h3>
