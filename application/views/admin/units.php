         ...
         <form method="post" enctype="multipart/form-data" action="<?php
            ...
            <div class="ms-md-4 pe-md-3 d-flex align-items-center" style="width: 30%">
               <div class="d-flex align-items-center ms-md-auto ">
                  <input type="text" class="form-control" required name="txtuname"  value="<?php
                     if(isset($isUpdate))
                     {
                        echo $unitinfo[0]->type;
                     }
                     ...
                     <div class="card-body px-3 pt-0 pb-2">
                        <div class="table-responsive p-0">
                           <table class="table align-items-center mb-0" id="basic-1">
                              <thead>
                                 <tr>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 align-middle text-center">Unit ID</th>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 align-middle text-center">Unit Type</th>
                              ...
                              <tbody >
                                 ...
                                 <tr>
                                    ...
                                    <td class="align-middle text-center text-sm">
                                       ...
                                       <a href='<?=site_url("admin/units/loadEdit/$u->unitid")?>'>Update</a>
                                       </span>
                                       <span class="badge badge-sm bg-gradient-danger">
                                       <a  href='<?=site_url("admin/units/removeunit/$u->unitid") ?>'>Delete</a>
                                       </span>
                                    </td>
                                 </tr>
                                 <?php
