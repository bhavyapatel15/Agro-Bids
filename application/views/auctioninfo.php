                ...
                ?>
                 <div class="card-container">
                        ...
                        <div class="card-attribute">
                           <a href="<?=site_url('farmermoreinfo/index/'.$a->farmerid)?>"><img src="<?=base_url('resources/user/assets/img/'.$a->profilephoto)?>" alt="avatar" class="small-avatar"/></a>
                           <p class="text-dark">Created By<span><a class="text-dark font-weight-bold" href="<?=site_url('farmermoreinfo/index/'.$a->farmerid)?>"> <?=$a->farmername?></a></span></p>
                        </div>
                            <?php
                            ...
                            ?>
                                  <div class="card-attribute">
                                        ...
                                        <p class="text-dark">Sold To<span><a class="text-dark font-weight-bold" href="#"> <?=$b->buyername?></a></span></p>
                                    </div>
                            <?php 
                                        }
                                        elseif($b->status==2)
                            ...
                            ?>
                                      <div class="card-attribute">
                                        <img src="<?=base_url('resources/user/assets/img/'.$b->profilephoto)?>" alt="avatar" class="small-avatar"/>
                                        <p class="text-dark">Bid Selected<span><a class="text-dark font-weight-bold" href="#"> <?=$b->buyername?></a></span></p>
                                    </div>
                            <?php                
                                        }
                                    }
                        ...
                        <div class="card-attribute">
                           ...
                           <p class="text-dark">Start Date <span><a class="text-dark font-weight-bold" href="#"> <?php echo date("d-m-Y", strtotime($a->auctionstartdt)) ?></a></span></p>
                        </div>
                        <div class="card-attribute">
                           <img src="https://i.postimg.cc/prpyV4mH/clock-selection-no-bg.png" alt="clock" class="small-image"/>
                 ...
                 <div class="col-md-6">
                    <?php
                            ...
                            <form  method="post"  enctype="multipart/form-data" action="<?php
                                             ...
                                             if(count($bid)>0)
                                             {
                                                  if($bid[0]->buyerid==$_SESSION['bid'])
                                                   {
                                                      echo site_url('auctioninfo/updatebid/'.$bid[0]->bidid.'/'.$auctionInfo[0]->auctionid);
                                                   }
                                             }
                                             else
                                               echo site_url('auctioninfo/insertbid/'.$_SESSION['bid'].'/'.$auctionInfo[0]->auctionid);       
                            ...
                            ?>
                                ...
                                if(count($bidInfo)==0)
                                {
                                    echo "<h1 class='text-dark' align='center' style='font-size:19px'><strong>Be the first to bid..</strong></h1>";
                                }
                            ?>
                                      <div class="product-details">
                                          <p class="text-center"> Enter Your Bid Amount</p><br><input required type="text" name="txtbid"  class="form-control">    
                                      </div> 
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                 ...
                                                 <div class="col-md-7">  
                                                    <input type="submit" class="btn btn-success" name="btnAddBid" placeholder="<?php 
                                                    if(count($bid)>0)
                                                    {
                                                         echo $bid[0]->bidamount;
                                                    }    
                     ...
                     <div class="col-md-4">
                        <div class="product-card">
                             ...
                             ?></div>
                              ...
                              <div class="product-details">
                                 <span class="span1 product-catagory"></span>
                                 <h4><a href=""><?=$b->buyername?></a></h4>
                                 <div class="product-bottom-details">
                                       Bid Amount&nbsp&nbsp<span class="span1 product-price"><?=$b->bidamount?></span>    
                                       <?php
                                         if($auctionInfo[0]->status==1)
                                         {
                                            if($_SESSION['bid']==$b->buyerid)
                                            {
                                        ?>
                                           <div><a style="color:red" href="<?=site_url('auctioninfo/removebid/'.$b->bidid."/".$b->auctionid)?>">Delete My Bid</a></div>
                                        <?php        
                                            }
                                        }
                                       ?>              
